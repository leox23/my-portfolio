...
export default function ExperienceCard({experience}: Props) {
  return (
    <article className="flex flex-col !justify-center rounded-lg items-center flex-shrink-0 snap-center bg-[#292929]  overflow-hidden 
    ...
    2xl:p-10">
      ...
      />
      <div className="px-0 space-y-[calc(2vh-5px)]
        md:px-10
        xl:pl-16">
        ...
        <ul className="list-disc overflow-y-scroll scrollbar-thin scrollbar-track-black scrollbar-thumb-[#f7ab0a]/80
