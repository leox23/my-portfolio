...
function Projects({ projects }: Props) {
  return (
    ...
    >
      <h3
        className="uppercase tracking-[20px] text-gray-500 !text-center
      ...
      <div
        className="relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80 items-center
      p-0 
      grow-[2]
      lg:-mt-14
      xl:-mt-[16vh]
      ...
      >
        {projects.map((project, i) => (
          <div
            className="card w-screen  min-h-fit flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center x
          !p-0 grow-[2]
          sm:p-20 
          ...
          >
            ...
            <div className="space-y-2 sm:space-y-10 px-0 md:px-10 max-w-6xl  ">
              ...
              <p
                className="project-summary text-center 
              text-lg 
              ms:px-2
