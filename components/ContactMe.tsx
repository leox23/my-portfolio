...
function ContactMe({ pageInfo }: Props) {
  ...
  return (
    <div
      className="h-screen w-screen flex relative flex-col justify-evenly mx-auto items-center
    ...
    >
      ...
      >
        ...
        >
          ...
          <span
            className="decoration-[#F7AB0A]/50 underline first-letter 
          "
          >
            Let{`'`}s Talk
          </span>
        ...
        <div className="space-y-2  sm:space-y-6  lg:space-y-1">
          <div className="flex items-center space-x-5 justify-center">
            ...
            />
            <PhoneIcon
              className="text-[#F7AB0A] animate-pulse !ml-1
              h-5 w-5
              mx:h-6 mx:w-6
              sm:h-7 sm:w-7"
            />
            <a
              href={`https://api.whatsapp.com/send?phone=${pageInfo?.phoneNumber}&text=%F0%9F%96%90%F0%9F%8F%BC%20Hi%20Leonel!%20%20how%20are%20you?%20`}
        ...
        lg:flex-row lg:space-y-0"
          >
            ...
            {errors.name?.type === "maxLength" && (
              <p>The name field must have a maximum of 12 characters.</p>
            )}
            ...
            {errors.email?.type === "pattern" && (
              <p>The email field must have a valid email</p>
            )}
          </div>
          ...
          {errors.subject?.type === "required" && (
            <p>The subject field must be at least 20 characters</p>
          )}
          <textarea
            {...register("message")}
            placeholder="Message"
